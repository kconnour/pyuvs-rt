...
f = np.load('/home/kyle/ssa_retrievals/iteration1/new-fsp_new-pf_hapke-wolff_2-0size.npy')
...
plt.ylabel('SSA')
plt.title('2.0 micron dust')
plt.legend()
plt.savefig('/home/kyle/ssa_retrievals/iteration1/new-fsp_new-pf_hapke-wolff_2-0size.png', dpi=300)
'''plt.clf()
