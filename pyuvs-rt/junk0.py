...
f = np.load('/home/kyle/ssa_retrievals/iteration1/new-fsp_new-pf_hapke-wolff_1-4size.npy')
g = np.load('/home/kyle/ssa_retrievals/iteration1/new-fsp_new-pf_hapke-wolff_1-6size.npy')
h = np.load('/home/kyle/ssa_retrievals/iteration1/new-fsp_new-pf_hapke-wolff_1-8size.npy')
i = np.load('/home/kyle/ssa_retrievals/iteration1/new-fsp_new-pf_hapke-wolff_2-0size.npy')
...
plt.legend()
#plt.savefig('/home/kyle/ssa_retrievals/iteration1/avg.png')
...
np.savetxt('/home/kyle/ssa_retrievals/iteration1/results.csv', result, delimiter=',')
