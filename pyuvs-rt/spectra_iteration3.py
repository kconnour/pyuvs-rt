...
f = np.load('/home/kyle/ssa_retrievals/iteration3/new-fsp_new-pf_hapke-wolff_1-4size.npy')
g = np.load('/home/kyle/ssa_retrievals/iteration3/new-fsp_new-pf_hapke-wolff_1-6size.npy')
h = np.load('/home/kyle/ssa_retrievals/iteration3/new-fsp_new-pf_hapke-wolff_1-8size.npy')
i = np.load('/home/kyle/ssa_retrievals/iteration3/new-fsp_new-pf_hapke-wolff_2-0size.npy')
...
h = np.mean(h[inds], axis=0) + 0.07
i = np.mean(i[inds], axis=0) + 0.07
...
plt.legend()
plt.savefig('/home/kyle/ssa_retrievals/iteration3/avg.png')
...
np.savetxt('/home/kyle/ssa_retrievals/iteration3/results.csv', result, delimiter=',')
