...
f = np.load('/home/kyle/ssa_retrievals/iteration4/new-fsp_new-pf_hapke-wolff_1-4size.npy')
g = np.load('/home/kyle/ssa_retrievals/iteration4/new-fsp_new-pf_hapke-wolff_1-6size.npy')
h = np.load('/home/kyle/ssa_retrievals/iteration4/new-fsp_new-pf_hapke-wolff_1-8size.npy')
i = np.load('/home/kyle/ssa_retrievals/iteration4/new-fsp_new-pf_hapke-wolff_2-0size.npy')
w = [230, 260, 280, 300]
# TODO: Fix (delete) these iteration 5
fcorr = np.interp(wavs, w, [0.02, 0.02, 0, 0])
...
plt.legend()
plt.savefig('/home/kyle/ssa_retrievals/iteration4/avg0.png')
...
np.savetxt('/home/kyle/ssa_retrievals/iteration4/results.csv', result, delimiter=',')
