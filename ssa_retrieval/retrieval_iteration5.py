...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
aux_files_path = f'/home/kyle/dustssa/kyle_iter{iteration}_radprop'
...
pgrad = np.linspace(1.6, 1.6, num=len(z_boundaries) - 1)
wave_ref = 0.88
...
np.save(f'/home/kyle/ssa_retrievals/iteration{iteration}/new-fsp_new-pf_lambert-clancy_1-6size.npy', retrieved_ssas)
t1 = time.time()
print(t1-t0)
